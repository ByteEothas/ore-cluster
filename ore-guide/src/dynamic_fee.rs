...
pub async fn dynamic_fee(rpc_client: &RpcClient, rpc_url: &String) -> Result<u64, String> {
...
pub async fn local_dynamic_fee(client: &RpcClient) -> Result<u64, Box<dyn std::error::Error>> {
    let pubkey = [
